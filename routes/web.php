...
Route::post('/ficha-tecnica/{id}', 'ProductController@dataSheetDestroy')->name('borrar-ficha-tecnica');
...
Route::get('download-archive/{column}/{id}', 'ContentController@downloadArchive')->name('download-archive');
Route::middleware('auth')->prefix('admin')->group(function () {
    ...
    Route::post('home/content/update', 'HomeController@updateSection')->name('home.content.update');
